  ...
  return (
    <div className="containerProperties">
      ...
      <div className="menuHead">
        <ButtonControl onClick={() => handleListProperties()}>
          Listar Imóveis
        </ButtonControl>
      ...
      {registerProperties && (
        <ContainerForm>
          ...
          {newRegisterOwner && (
            <div className="newRegister">
              <div className="containerNewRegister">
                <Owners
                  newRegister={newRegisterOwner}
                  setNewRegister={setNewRegisterOwner}
                />
              </div>
            </div>
          )}
          <form onSubmit={handleSubmit}>
                  ...
                  >
                    ...
                    {owners.length > 0 &&
                      owners.map((owner, index) => (
                        <option key={index} value={owner[0].name}>
                          {owner[0].name}
                        </option>
                      ))}
                  </select>
            ...
            <FormGroup>
              <ButtonControl style={{ margin: "10px auto 0" }} type="submit">
                Salvar
              </ButtonControl>
            </FormGroup>
          </form>
